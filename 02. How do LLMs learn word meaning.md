...
Computers do not understand words directly. Instead, text must be transformed into numbers—the data that machines can actually process. The idea is actually inspired by the study based on human performance. 
