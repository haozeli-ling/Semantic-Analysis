## 02. How do LLMs learn (static) word meaning
...
> is traditionally followed by $\color{blue}{\text{cherry}}$ pie, a traditional dissert <br>
> often mixed, such as $\color{blue}{\text{strawberry}}$ rhubarb pie. Apple pie <br>
> computer peripherals and personal $\color{blue}{\text{digital}}$ assistants. These devices usually <br>
> a computer. This includes $\color{blue}{\text{information}}$ available on the internet

![Alt Text](https://github.com/haozeli-ling/Semantic-Analysis/blob/main/word_embeddings2.png) 
...
![Alt Text](https://github.com/haozeli-ling/Semantic-Analysis/blob/main/word_embeddings.png)
