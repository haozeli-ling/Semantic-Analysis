...
![Alt Text](https://github.com/haozeli-ling/Semantic-Analysis/blob/main/lambda_abstraction.png)

> Discussion:  
> 
> What is the extensional meaning of 'bridge', and what is its semantic type? <br>
> What is the appropriate semantic type for the 'such that' clause?
...
```
F('such that_1 it_1 could withstand extreme weather conditions')
= lambda x : withstand_weather_f(x)
```
...
> 
> (a) the leader such that_1 the people follows his_1 advice without question
