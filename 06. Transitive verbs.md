...
The extensional meaning of a transitive verb can be understood as a set of pairs. Consider the following real situation happend at G7 2018: 
...
- A 'looking-at' relation: In mathematics, a relation denotes some kind of relationship between two objects in a set. Formally, a relation $R$ over a set $X$ can be seen as a set of ordered pairs $(x,y)$ of members of $X$. 

  - (Trump, Merkel)
  - (Merkel, Trump)
  - (Trudeau, Trump)
  - (Macron, Document $\apha$)
  - (May, Document $\apha$)
