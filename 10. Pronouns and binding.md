...
### Coreference, indices, and assignments
 ...
 Context clearly has an effect on the informational content of a sentence. For example, the truth condition of the sentence 'he golfs' varies from context to context. 
