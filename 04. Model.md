...
Model theory is a method--the most successful one defloped to date--for carrying out the program of investigating the relation between languages and reality. 
